...
pmem_map(int fd, size_t len) {
  ...
  if ((base = mmap(0, len, PROT_READ | PROT_WRITE,
...
void pmemalloc_creat_thread(VoidFun fun, void* args);
...
void pmemalloc_band_start();
void pmemalloc_band_end();
void pmemalloc_band_output();
