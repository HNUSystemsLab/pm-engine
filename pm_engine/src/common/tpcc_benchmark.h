...
class tpcc_benchmark : public benchmark {
 public:
  ...
  // Table Ids
  static constexpr int ITEM_TABLE_ID = 0; //1.5M
  static constexpr int WAREHOUSE_TABLE_ID = 1; //150B
  static constexpr int DISTRICT_TABLE_ID = 2; // 300B
  static constexpr int CUSTOMER_TABLE_ID = 3; //879K
  static constexpr int ORDERS_TABLE_ID = 4; // 5.2M
  static constexpr int ORDER_LINE_TABLE_ID = 5; //49M
  static constexpr int NEW_ORDER_TABLE_ID = 6; //20K
  static constexpr int HISTORY_TABLE_ID = 7; // 1.5M
  static constexpr int STOCK_TABLE_ID = 8; //15M
